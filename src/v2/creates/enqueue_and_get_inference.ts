...
import { reqInferencePost, pollForInference, setupEnqueueBody } from "../utils/mindeeApi.js";
...
const perform = (async (z, bundle) => {
  ...
  const jobId = await reqInferencePost(z, body).then(response => response.data.job.id);
